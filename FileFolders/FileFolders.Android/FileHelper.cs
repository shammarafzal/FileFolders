...
namespace FileFolders.Droid
{
    public class FileHelper : IFile
    {
       ...
       // private readonly string _rootDir = Path.Combine(System.Environment.CurrentDirectory, "sdcard/Android/data/com.arumsolution.filefolders/files/Pictures/Files/", "pdfjs");
